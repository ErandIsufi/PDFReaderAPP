...
public final class ActivityPdfViewerBinding implements ViewBinding {
  ...
  private ActivityPdfViewerBinding(@NonNull RelativeLayout rootView, @NonNull PDFView pdfView) {
  ...
  public static ActivityPdfViewerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityPdfViewerBinding((RelativeLayout) rootView, pdfView);
    }
